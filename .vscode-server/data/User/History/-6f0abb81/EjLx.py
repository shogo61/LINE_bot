            ...
            with connection.cursor() as cursor:
                ...
                for i in range(len(ary1)):
                    ...
                    if i >= 3:
                        break
                # logging.debug(sql)
                id = connection.from ast import Delete
from re import search
from sqlite3 import Cursor
import pymysql  # 参考: https://pymysql.readthedocs.io/en/latest/index.html
import pymysql.cursors
        ...
        try:
            with connection.cursor() as cursor:
                ...
                # for i in range(length):
                    # logging.debug(i)
                # sql = "INSERT INTO main_table (name, cal) VALUES (%s,%s);"
                sql = "INSERT INTO main_table (name, cal) VALUES (%s,%s),(%s,%s),(%s,%s),(%s,%s);"
                cursor.execute(sql, (ary1[0], ary2[0],ary1[1], ary2[1],ary1[2], ary2[2],ary1[3], ary2[3],))
                logging.debug(sql)
